 ...
 * @date 2017/2/16
 */
class ReadNextForPageFunc implements Func2<Object, Map<String, Object>, String> {
    @Override
    Object func(Map<String, Object> map, String key) {
        boolean hasNext = this.getHasNext(map, key)
    ...
    def getHasNext(Map<String, Object> map, String key) {
