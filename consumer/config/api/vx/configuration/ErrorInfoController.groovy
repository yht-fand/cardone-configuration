...
class ErrorInfoController {
    ...
    Object c0001Json(HttpServletRequest request) {
        ApplicationContextHolder.getBean(WebSupport.class).func(request, { input -> ApplicationContextHolder.getBean(ErrorInfoService.class).insertByNotExistsCache(input) })
    }
    /** /c0001.json end **/
}