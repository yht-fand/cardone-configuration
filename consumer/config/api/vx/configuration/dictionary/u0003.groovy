...
//      }
		...
		def dbDictionaryId = ApplicationContextHolder.getBean(DictionaryService.class).readOne(String.class, readOne)

		if (!StringUtils.equals(dbDictionaryId, input.dictionaryId)) {
