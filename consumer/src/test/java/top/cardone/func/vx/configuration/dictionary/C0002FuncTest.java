...
public class C0002FuncTest {
    @Value("http://localhost:${server.port:8765}/cardone-configuration/vx/configuration/dictionary/c0002.json")
    private String funcUrl;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/configuration/dictionary/C0002FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/configuration/dictionary/C0002FuncTest.func.output.json")
