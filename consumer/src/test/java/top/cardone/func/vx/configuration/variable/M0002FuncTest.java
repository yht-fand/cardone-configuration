...
public class M0002FuncTest {
    @Value("http://localhost:${server.port:8765}${server.servlet.context-path:}/vx/configuration/variable/m0002.json")
    private String funcUrl;

    @Value("file:src/test/resources/top/cardone/func/vx/configuration/variable/M0002FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("file:src/test/resources/top/cardone/func/vx/configuration/variable/M0002FuncTest.func.output.json")
