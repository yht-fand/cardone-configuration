...
public class C0004FuncTest {
    ...
    @Value("${app.root}/src/test/java/top/cardone/func/vx/configuration/navigation/C0004FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/configuration/navigation/C0004FuncTest.func.output.json")
