package top.cardone.func.vx.configuration.errorInfo;
...
public class ModifyModalFuncTest {
    @Value("http://localhost:${server.port:8765}${server.context-path:}/vx/configuration/errorInfo/modifyModal.json")
    private String funcUrl;

    @Value("${app.root}/src/test/resources/top/cardone/func/vx/configuration/errorInfo/ModifyModalFuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/resources/top/cardone/func/vx/configuration/errorInfo/ModifyModalFuncTest.func.output.json")
