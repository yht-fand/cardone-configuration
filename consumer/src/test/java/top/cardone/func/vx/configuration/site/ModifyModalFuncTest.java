package top.cardone.func.vx.configuration.site;
...
public class ModifyModalFuncTest {
    @Value("http://localhost:${server.port:8765}${server.context-path:}/vx/configuration/site/modifyModal.json")
    private String funcUrl;

    @Value("${app.root}/src/test/resources/top/cardone/func/vx/configuration/site/ModifyModalFuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/resources/top/cardone/func/vx/configuration/site/ModifyModalFuncTest.func.output.json")
