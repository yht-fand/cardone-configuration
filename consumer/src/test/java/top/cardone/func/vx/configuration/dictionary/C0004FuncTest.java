...
public class C0004FuncTest {
    ...
    @Value("${app.root}/src/test/resources/top/cardone/func/vx/configuration/dictionary/C0004FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/resources/top/cardone/func/vx/configuration/dictionary/C0004FuncTest.func.output.json")
