...
public class R0001FuncTest {
    @Value("http://localhost:${server.port:8765}${server.context-path:}/vx/configuration/i18nInfo/r0001.json")
    private String funcUrl;

    @Value("${app.root}/src/test/resources/top/cardone/func/vx/configuration/i18nInfo/R0001FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/resources/top/cardone/func/vx/configuration/i18nInfo/R0001FuncTest.func.output.json")
