...
public class AddModalFuncTest {
    @Value("http://localhost:${server.port:8765}${server.servlet.context-path:}/vx/configuration/systemInfo/addModal.json")
    private String funcUrl;

    @Value("file:src/test/resources/top/cardone/func/vx/configuration/systemInfo/AddModalFuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("file:src/test/resources/top/cardone/func/vx/configuration/systemInfo/AddModalFuncTest.func.output.json")
