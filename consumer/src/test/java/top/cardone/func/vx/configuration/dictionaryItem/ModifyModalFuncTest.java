package top.cardone.func.vx.configuration.dictionaryItem;
...
public class ModifyModalFuncTest {
    @Value("http://localhost:${server.port:8765}${server.context-path:}/vx/configuration/dictionaryItem/modifyModal.json")
    private String funcUrl;

    @Value("${app.root}/src/test/resources/top/cardone/func/vx/configuration/dictionaryItem/ModifyModalFuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/resources/top/cardone/func/vx/configuration/dictionaryItem/ModifyModalFuncTest.func.output.json")
