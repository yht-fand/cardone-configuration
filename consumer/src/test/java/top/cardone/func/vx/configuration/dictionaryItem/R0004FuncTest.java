...
public class R0004FuncTest {
    ...
    @Value("${app.root}/src/test/java/top/cardone/func/vx/configuration/dictionaryItem/R0004FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/configuration/dictionaryItem/R0004FuncTest.func.output.json")
