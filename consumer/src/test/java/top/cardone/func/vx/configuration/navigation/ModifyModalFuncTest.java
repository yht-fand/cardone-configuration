...
public class ModifyModalFuncTest {
    @Value("http://localhost:${server.port:8765}/${server.context-path:}/vx/configuration/navigation/modifyModal.json")
    private String funcUrl;

    @Value("${app.root}/src/test/resources/top/cardone/func/vx/configuration/navigation/ModifyModalFuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/resources/top/cardone/func/vx/configuration/navigation/ModifyModalFuncTest.func.output.json")
