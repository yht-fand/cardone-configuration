...
public class IndexFuncTest {
    ...
    @Value("${app.root}/src/test/java/top/cardone/func/vx/configuration/navigation/IndexFuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/configuration/navigation/IndexFuncTest.func.output.json")
