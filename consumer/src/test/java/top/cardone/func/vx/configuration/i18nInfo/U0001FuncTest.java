...
public class U0001FuncTest {
    @Value("http://localhost:${server.port:8765}/cardone-configuration/vx/configuration/i18nInfo/u0001.json")
    private String funcUrl;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/configuration/i18nInfo/U0001FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/configuration/i18nInfo/U0001FuncTest.func.output.json")
