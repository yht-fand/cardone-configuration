...
public class D0004FuncTest {
    @Value("http://localhost:${server.port:8765}${server.context-path:}/vx/configuration/errorInfo/d0004.json")
    private String funcUrl;

    @Value("${app.root}/src/test/resources/top/cardone/func/vx/configuration/errorInfo/D0004FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/resources/top/cardone/func/vx/configuration/errorInfo/D0004FuncTest.func.output.json")
