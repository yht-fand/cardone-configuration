...
public class ErrorInfoController {
    ...
    public Object c0001Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Object>) input -> ApplicationContextHolder.getBean(ErrorInfoService.class).insertByNotExistsCache(input));
    }
    /** /c0001.json end **/
    ...
    public Object d0001Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Object>) input -> ApplicationContextHolder.getBean(ErrorInfoService.class).deleteByIdsCache(input));
    }
    /** /d0001.json end **/
    ...
    public Object m0001Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Object>) input -> ApplicationContextHolder.getBean(ErrorInfoService.class).findOne(input));
    }
    /** /m0001.json end **/
    ...
    public Object r0001Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Object>) input -> ApplicationContextHolder.getBean(ErrorInfoService.class).page(input));
    }
    /** /r0001.json end **/
    ...
    public Object u0001Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Object>) input -> ApplicationContextHolder.getBean(ErrorInfoService.class).updateCache(input));
    }
    /** /u0001.json end **/
    ...
    public Object addModalJson(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Object>) input -> ApplicationContextHolder.getBean(ErrorInfoService.class).findOneByErrorInfoId(input));
    }
    /** /addModal.json end **/
