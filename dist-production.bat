...
xcopy provider\target\cardone-configuration-provider-*.jar dist\production\provider /Y/C/R/I
...
xcopy consumer\target\cardone-configuration-consumer-*.jar dist\production\consumer /Y/C/R/I
pause