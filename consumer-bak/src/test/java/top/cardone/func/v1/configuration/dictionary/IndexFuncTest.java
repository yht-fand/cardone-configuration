...
public class IndexFuncTest {
    ...
    @Value("file:src/test/resources/top/cardone/func/v1/configuration/dictionary/IndexFuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("file:src/test/resources/top/cardone/func/v1/configuration/dictionary/IndexFuncTest.func.output.json")
