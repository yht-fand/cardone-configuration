package top.cardone.func.v1.configuration.variable;
...
public class ModifyModalFuncTest {
    @Value("http://localhost:${server.port:8765}${server.servlet.context-path:}/v1/configuration/variable/modifyModal.json")
    private String funcUrl;

    @Value("file:src/test/resources/top/cardone/func/v1/configuration/variable/ModifyModalFuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("file:src/test/resources/top/cardone/func/v1/configuration/variable/ModifyModalFuncTest.func.output.json")
