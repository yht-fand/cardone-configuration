 ...
 */
@Controller
@RequestMapping("/v1/configuration/dictionaryItem")
class DictionaryItemController {
    ...
    Object c0001Json(HttpServletRequest request) {
        ApplicationContextHolder.getBean(WebSupport.class).func(request, { input -> ApplicationContextHolder.getBean(DictionaryItemService.class).insertByNotExistsCache(input) })
    }
    /** /c0001.json end **/
}