...
xcopy provider\target\cardone-configuration-provider-*.jar dist\test\provider /Y/C/R/I
...
xcopy consumer\target\cardone-configuration-consumer-*.jar dist\test\consumer /Y/C/R/I
pause