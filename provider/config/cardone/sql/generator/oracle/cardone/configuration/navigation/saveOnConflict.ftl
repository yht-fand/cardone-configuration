...
<#if (index_dataOption??)>
${prefixName?string('', 'AND ')}A.DATA_OPTION = B.DATA_OPTION
<#assign prefixName = false>
</#if>
<#if (index_dataStateCode??)>
...
<#if (index_iconStyle??)>
${prefixName?string('', 'AND ')}A.ICON_STYLE = B.ICON_STYLE
<#assign prefixName = false>
</#if>
<#if (index_jsonData??)>
...
<#if (index_navigationCode??)>
${prefixName?string('', 'AND ')}A.NAVIGATION_CODE = B.NAVIGATION_CODE
<#assign prefixName = false>
</#if>
<#if (index_navigationId??)>
${prefixName?string('', 'AND ')}A.NAVIGATION_ID = B.NAVIGATION_ID
<#assign prefixName = false>
</#if>
<#if (index_orderBy??)>
...
<#if (index_target??)>
${prefixName?string('', 'AND ')}A.TARGET = B.TARGET
<#assign prefixName = false>
</#if>
<#if (index_typeCode??)>
