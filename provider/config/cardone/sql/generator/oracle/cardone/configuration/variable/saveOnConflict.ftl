...
${prefixName?string('', ', ')} :index_variableCode_value AS VARIABLE_CODE
<#assign prefixName = false>
</#if>
<#if (index_variableId??)>
${prefixName?string('', ', ')} :index_variableId_value AS VARIABLE_ID
<#assign prefixName = false>
</#if>
<#if (index_version??)>
...
<#if (index_variableCode??)>
${prefixName?string('', 'AND ')}A.VARIABLE_CODE = B.VARIABLE_CODE
<#assign prefixName = false>
</#if>
<#if (index_variableId??)>
${prefixName?string('', 'AND ')}A.VARIABLE_ID = B.VARIABLE_ID
<#assign prefixName = false>
</#if>
<#if (index_version??)>
...
<#if (update_variableCode??)>
${prefixName?string('', ', ')}A.VARIABLE_CODE = :update_variableCode_value
<#assign prefixName = false>
</#if>
<#if (update_variableId??)>
${prefixName?string('', ', ')}A.VARIABLE_ID = :update_variableId_value
<#assign prefixName = false>
</#if>
<#if (update_version??)>
