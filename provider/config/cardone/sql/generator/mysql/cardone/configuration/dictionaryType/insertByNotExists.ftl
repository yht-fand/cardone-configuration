...
FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM c1_dictionary_type E
...
${prefixName} E.DICTIONARY_TYPE_ID = :where_and_eq_dictionaryTypeId_value
<#else>
${prefixName} E.DICTIONARY_TYPE_ID IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (prefixName!) != 'WHERE'>
