...
${prefixName} `SYSTEM_INFO_ID` = :where_and_eq_systemInfoId_value
<#else>
${prefixName} `SYSTEM_INFO_ID` IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_and_nq_systemInfoId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_nq_systemInfoId_value??)>
${prefixName} `SYSTEM_INFO_ID` <> :where_and_nq_systemInfoId_value
<#else>
${prefixName} `SYSTEM_INFO_ID` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_and_like_systemInfoId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_like_systemInfoId_value??)>
${prefixName} `SYSTEM_INFO_ID` <> :where_and_like_systemInfoId_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_eq_systemInfoId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_eq_systemInfoId_value??)>
${prefixName} `SYSTEM_INFO_ID` = :where_or_eq_systemInfoId_value
<#else>
${prefixName} `SYSTEM_INFO_ID` IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_nq_systemInfoId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_nq_systemInfoId_value??)>
${prefixName} `SYSTEM_INFO_ID` <> :where_or_nq_systemInfoId_value
<#else>
${prefixName} `SYSTEM_INFO_ID` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_like_systemInfoId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_like_systemInfoId_value??)>
${prefixName} `SYSTEM_INFO_ID` like :where_or_like_systemInfoId_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (prefixName!) != 'WHERE'>
