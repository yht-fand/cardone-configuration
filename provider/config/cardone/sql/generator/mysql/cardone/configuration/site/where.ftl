...
<#if (where_and_nq_siteId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_nq_siteId_value??)>
...
<#if (where_and_like_siteId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_like_siteId_value??)>
${prefixName} `SITE_ID` <> :where_and_like_siteId_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_eq_siteId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_eq_siteId_value??)>
${prefixName} `SITE_ID` = :where_or_eq_siteId_value
<#else>
${prefixName} `SITE_ID` IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_nq_siteId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_nq_siteId_value??)>
${prefixName} `SITE_ID` <> :where_or_nq_siteId_value
<#else>
${prefixName} `SITE_ID` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_like_siteId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_like_siteId_value??)>
${prefixName} `SITE_ID` like :where_or_like_siteId_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (prefixName!) != 'WHERE'>
