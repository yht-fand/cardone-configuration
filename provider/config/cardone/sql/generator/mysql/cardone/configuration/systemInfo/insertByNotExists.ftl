...
<#if (insert_systemInfoId??) && (insert_systemInfoId_value??)>
${prefixName} :insert_systemInfoId_value
<#assign prefixName = ','>
</#if>
<#if (insert_version??) && (insert_version_value??)>
...
FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM c1_system_info E
...
${prefixName} E.SYSTEM_INFO_ID = :where_and_eq_systemInfoId_value
<#else>
${prefixName} E.SYSTEM_INFO_ID IS NULL
</#if>
<#assign prefixName = 'AND'>
</#if>
