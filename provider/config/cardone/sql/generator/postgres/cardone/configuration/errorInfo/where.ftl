...
${prefixName?string('WHERE ', 'AND ')}"error_info_code" = :where_and_eq_errorInfoCode_value
<#else>
${prefixName?string('WHERE ', 'AND ')}"error_info_code" IS NULL
</#if>
<#assign prefixName = false>
</#if>
<#if (where_and_eq_errorInfoId??)>
<#if (where_and_eq_errorInfoId_value??)>
${prefixName?string('WHERE ', 'AND ')}"error_info_id" = :where_and_eq_errorInfoId_value
<#else>
${prefixName?string('WHERE ', 'AND ')}"error_info_id" IS NULL
</#if>
<#assign prefixName = false>
</#if>
...
<#else>
${prefixName?string('WHERE ', 'AND ')}"url" IS NULL
</#if>
<#assign prefixName = false>
</#if>
