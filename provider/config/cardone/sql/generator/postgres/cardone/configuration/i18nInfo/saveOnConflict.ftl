...
${prefixName?string('', ', ')}"i18n_info_code" = :update_i18nInfoCode_value
<#assign prefixName = false>
</#if>
<#if (update_i18nInfoId??)>
${prefixName?string('', ', ')}"i18n_info_id" = :update_i18nInfoId_value
<#assign prefixName = false>
</#if>
<#if (update_jsonData??)>
...
<#if (update_language??)>
${prefixName?string('', ', ')}"language" = :update_language_value
<#assign prefixName = false>
</#if>
