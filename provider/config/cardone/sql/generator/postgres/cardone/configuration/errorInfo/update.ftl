...
${prefixName?string('SET ', ', ')}"error_info_code" = :update_errorInfoCode_value
<#assign prefixName = false>
</#if>
<#if (update_errorInfoId??)>
${prefixName?string('SET ', ', ')}"error_info_id" = :update_errorInfoId_value
<#assign prefixName = false>
</#if>
<#if (update_flagCode??)>
...
${prefixName?string('SET ', ', ')}"object_code" = :update_objectCode_value
<#assign prefixName = false>
</#if>
<#if (update_objectId??)>
${prefixName?string('SET ', ', ')}"object_id" = :update_objectId_value
<#assign prefixName = false>
</#if>
<#if (update_objectTypeCode??)>
${prefixName?string('SET ', ', ')}"object_type_code" = :update_objectTypeCode_value
<#assign prefixName = false>
</#if>
<#if (update_orderBy??)>
