...
<#else>
${prefixName?string('WHERE ', 'AND ')}"dictionary_code" IS NULL
</#if>
<#assign prefixName = false>
</#if>
...
<#else>
${prefixName?string('WHERE ', 'AND ')}"dictionary_item_code" IS NULL
</#if>
<#assign prefixName = false>
</#if>
...
<#else>
${prefixName?string('WHERE ', 'AND ')}"dictionary_item_id" IS NULL
</#if>
<#assign prefixName = false>
</#if>
...
<#else>
${prefixName?string('WHERE ', 'AND ')}"dictionary_type_code" IS NULL
</#if>
<#assign prefixName = false>
</#if>
...
<#else>
${prefixName?string('WHERE ', 'AND ')}"explain_" IS NULL
</#if>
<#assign prefixName = false>
</#if>
...
<#else>
${prefixName?string('WHERE ', 'AND ')}"value_" IS NULL
</#if>
<#assign prefixName = false>
</#if>
