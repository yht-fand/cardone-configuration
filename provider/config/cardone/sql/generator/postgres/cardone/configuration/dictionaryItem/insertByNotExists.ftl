...
WHERE NOT EXISTS (SELECT 1 FROM c1_dictionary_item E
...
${prefixName} E.dictionary_item_code = :where_and_eq_dictionaryItemCode_value
<#else>
${prefixName} E.dictionary_item_code IS NULL
</#if>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_eq_dictionaryItemId??)>
<#if (where_and_eq_dictionaryItemId_value??)>
${prefixName} E.dictionary_item_id = :where_and_eq_dictionaryItemId_value
<#else>
${prefixName} E.dictionary_item_id IS NULL
</#if>
<#assign prefixName = 'AND'>
</#if>
