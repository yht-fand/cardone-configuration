...
xcopy provider\target\cardone-configuration-provider-*.jar dist\demo\provider /Y/C/R/I
...
xcopy consumer\target\cardone-configuration-consumer-*.jar dist\demo\consumer /Y/C/R/I
pause