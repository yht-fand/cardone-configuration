...
xcopy provider\target\superstring-sync-provider-*.jar dist\demo\provider /Y/C/R/I
...
xcopy consumer\target\superstring-sync-consumer-*.jar dist\demo\consumer /Y/C/R/I
pause