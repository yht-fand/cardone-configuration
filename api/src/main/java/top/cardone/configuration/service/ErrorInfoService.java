...
@CacheConfig(cacheNames = {"top.cardone.configuration.service.ErrorInfoService"})
...
public interface ErrorInfoService extends PageService {
    ...
    /**
     * @see top.cardone.configuration.service.ErrorInfoService#saveList
     */
    @CacheEvict(allEntries = true)
    @Transactional
     ...
     * @return 错误信息对象
     */
    default Map<String, Object> findOneByErrorInfoIdCache(Map<String, Object> findOne) {
        return this.findOneByErrorInfoId(findOne);
    }
