...
<#if (insert_i18nInfoId??) && (insert_i18nInfoId_value??)>
${prefixName} :insert_i18nInfoId_value
<#assign prefixName = ','>
</#if>
<#if (insert_lastModifiedByCode??) && (insert_lastModifiedByCode_value??)>
...
FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM t_i18n_info E
...
${prefixName} E.I18N_INFO_ID = :where_and_eq_i18nInfoId_value
<#else>
${prefixName} E.I18N_INFO_ID IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (prefixName!) != 'WHERE'>
