...
<#if (where_and_nq_dictionaryCode??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_nq_dictionaryCode_value??)>
${prefixName} `DICTIONARY_CODE` <> :where_and_nq_dictionaryCode_value
<#else>
${prefixName} `DICTIONARY_CODE` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_and_like_dictionaryCode??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_like_dictionaryCode_value??)>
${prefixName} `DICTIONARY_CODE` <> :where_and_like_dictionaryCode_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_eq_dictionaryCode??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_eq_dictionaryCode_value??)>
${prefixName} `DICTIONARY_CODE` = :where_or_eq_dictionaryCode_value
<#else>
${prefixName} `DICTIONARY_CODE` IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_nq_dictionaryCode??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_nq_dictionaryCode_value??)>
${prefixName} `DICTIONARY_CODE` <> :where_or_nq_dictionaryCode_value
<#else>
${prefixName} `DICTIONARY_CODE` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_like_dictionaryCode??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_like_dictionaryCode_value??)>
${prefixName} `DICTIONARY_CODE` like :where_or_like_dictionaryCode_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (prefixName!) != 'WHERE'>
...
${prefixName} `DICTIONARY_ID` = :where_and_eq_dictionaryId_value
<#else>
${prefixName} `DICTIONARY_ID` IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_and_nq_dictionaryId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_nq_dictionaryId_value??)>
${prefixName} `DICTIONARY_ID` <> :where_and_nq_dictionaryId_value
<#else>
${prefixName} `DICTIONARY_ID` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_and_like_dictionaryId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_like_dictionaryId_value??)>
${prefixName} `DICTIONARY_ID` <> :where_and_like_dictionaryId_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_eq_dictionaryId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_eq_dictionaryId_value??)>
${prefixName} `DICTIONARY_ID` = :where_or_eq_dictionaryId_value
<#else>
${prefixName} `DICTIONARY_ID` IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_nq_dictionaryId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_nq_dictionaryId_value??)>
${prefixName} `DICTIONARY_ID` <> :where_or_nq_dictionaryId_value
<#else>
${prefixName} `DICTIONARY_ID` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_like_dictionaryId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_like_dictionaryId_value??)>
${prefixName} `DICTIONARY_ID` like :where_or_like_dictionaryId_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (prefixName!) != 'WHERE'>
...
<#if (where_and_nq_explain??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_nq_explain_value??)>
${prefixName} `EXPLAIN_` <> :where_and_nq_explain_value
<#else>
${prefixName} `EXPLAIN_` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_and_like_explain??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_like_explain_value??)>
${prefixName} `EXPLAIN_` <> :where_and_like_explain_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_eq_explain??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_eq_explain_value??)>
${prefixName} `EXPLAIN_` = :where_or_eq_explain_value
<#else>
${prefixName} `EXPLAIN_` IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_nq_explain??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_nq_explain_value??)>
${prefixName} `EXPLAIN_` <> :where_or_nq_explain_value
<#else>
${prefixName} `EXPLAIN_` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_like_explain??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_like_explain_value??)>
${prefixName} `EXPLAIN_` like :where_or_like_explain_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (prefixName!) != 'WHERE'>
...
<#if (where_and_nq_value??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_nq_value_value??)>
${prefixName} `VALUE_` <> :where_and_nq_value_value
<#else>
${prefixName} `VALUE_` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_and_like_value??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_like_value_value??)>
${prefixName} `VALUE_` <> :where_and_like_value_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_eq_value??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_eq_value_value??)>
${prefixName} `VALUE_` = :where_or_eq_value_value
<#else>
${prefixName} `VALUE_` IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_nq_value??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_nq_value_value??)>
${prefixName} `VALUE_` <> :where_or_nq_value_value
<#else>
${prefixName} `VALUE_` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_like_value??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_like_value_value??)>
${prefixName} `VALUE_` like :where_or_like_value_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (prefixName!) != 'WHERE'>
