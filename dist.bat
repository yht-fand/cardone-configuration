...
xcopy provider\target\cardone-configuration-provider-*.jar dist\provider /Y/C/R/I
mkdir dist\consumer
xcopy consumer\config dist\consumer\config /Y/E/C/R/I
xcopy consumer\run.bat dist\consumer /Y/C/R/I
xcopy consumer\target\cardone-configuration-consumer-*.jar dist\consumer /Y/C/R/I
pause