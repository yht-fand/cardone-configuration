...
xcopy provider\target\cardone-configuration-provider-*.jar dist\%1\provider /Y/C/R/I
...
xcopy consumer\target\cardone-configuration-consumer-*.jar dist\%1\consumer /Y/C/R/I
